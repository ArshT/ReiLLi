...
from algorithms.Deep_Q_Learning.deep_q_learning_agent import DQL_agent
...
dql_agent = DQL_agent(env_name=env_name,num_episodes=num_episodes,batch_size=batch_size,gamma=gamma,solved_reward=solved_reward,replace=replace,epsilon=epsilon,
...
dql_agent.train(model_dir=model_dir,plot_dir=plot_dir)
dql_agent.test(model_dir=model_dir)
