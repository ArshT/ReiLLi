...
from algorithms.Double_Deep_Q_Learning.double_dql import Agent


class Double_DQL_agent:
    ...
    def train(self,model_dir=None,plot_dir=None):
        ...
        if plot_dir:
            plot_graph = RewardPlot(env_name=self.env_name,algo_name="DDQL",save_dir=plot_dir)
        ...
        if model_dir:
            save_dir = os.path.join(model_dir,"ddql_dict_"+self.env_name+".pth")
